function analyze_participant(inputprefix, outputprefix)
    ...
    dataset_description = struct(...
      ...
      'SourceDatasets', {struct(...
          'DOI', '10.18112/openneuro.ds000117.v1.0.6', ... % FIXME, the DOI of the input dataset should be inserted here
          'Version', '1.0.6' ...
      )}, ...
      'GeneratedBy', {struct(...
          'Name', 'MATLAB pipeline for SIESTA use case 2.3', ...
          'Description', 'Compute the ERF difference over the significant channels, contrasting two conditions', ...
          ...
          'Container', struct(...
              ...
              'URI', 'oras://ghcr.io/siesta-eu/pipeline-2.3.sif:latest' ...
          ) ...
      )} ...
    );

    dataset_description_json = fullfile(outputprefix, 'dataset_description.json');
