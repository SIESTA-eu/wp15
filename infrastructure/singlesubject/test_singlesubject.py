...
def test1(tmp_path):
    singlesubject.main(['argv0', test_path / 'test1', tmp_path / 'test1/singlesubject1', 'sub-01'])
    singlesubject.main(['argv0', test_path / 'test1', tmp_path / 'test1/singlesubject2', 'sub-02'])
    singlesubject.main(['argv0', test_path / 'test1', tmp_path / 'test1/singlesubject3', 'sub-03'])
...
def test2(tmp_path):
    singlesubject.main(['argv0', test_path / 'test2', tmp_path / 'test2/singlesubject1', 'sub-01'])
    singlesubject.main(['argv0', test_path / 'test2', tmp_path / 'test2/singlesubject2', 'sub-02'])
    singlesubject.main(['argv0', test_path / 'test2', tmp_path / 'test2/singlesubject3', 'sub-03'])

    # FIXME add some tests that are not yet in test1, no reason to repeat the same tests

def test3(tmp_path):
    singlesubject.main(['argv0', test_path / 'test3', tmp_path / 'test3/singlesubject1', 'sub-01'])
    singlesubject.main(['argv0', test_path / 'test3', tmp_path / 'test3/singlesubject2', 'sub-02'])
    singlesubject.main(['argv0', test_path / 'test3', tmp_path / 'test3/singlesubject3', 'sub-03'])
